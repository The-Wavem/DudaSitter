...
const heroImageUrl =
  "https://images.unsplash.com/photo-1544568100-847a948585b9?auto=format&fit=crop&q=80&w=1200&h=1500";
    ...
    <section className={styles.heroSection} ref={sectionRef}>
      ...
      <MotionDiv
        ...
        transition={
          prefersReducedMotion
            ? undefined
            : { repeat: Infinity, duration: 9, ease: "easeInOut", delay: 1 }
        }
          ...
          <div className={styles.heroContent}>
            <MotionDiv variants={fadeUp} className={styles.badge}>
              <span className={styles.badgeIcon}>
                <ShieldCheck
                  className={styles.badgeIconSvg}
                  aria-hidden="true"
                />
              </span>
              <span className={styles.badgeText}>
                Cuidada por futura Médica Veterinária (5º período)
              </span>
            </MotionDiv>
            ...
            <MotionP variants={fadeUp} className={styles.description}>
              Serviços especializados de Pet Sitter e Dog Walker em Curitiba,
              PR. Garantindo a alegria e o bem-estar do seu melhor amigo com
              segurança.
            </MotionP>
